			...
			else
			{
				...
				if ((var8 == Block.grass.blockID || var8 == Block.dirt.blockID) && par4 < 256 - var6 - 1)
				{
					...
					for (var11 = par4 - var9 + var6; var11 <= par4 + var6; ++var11)
					{
						...
						for (var14 = par3 - var13; var14 <= par3 + var13; ++var14)
						{
							...
							for (int var16 = par5 - var13; var16 <= par5 + var13; ++var16)
							{
								...
								{
									this.setBlockAndMetadata(par1World, var14, var11 + 10, var16, Block.leaves.blockID, 0);
									this.setBlockAndMetadata(par1World, var14, var11 + 6, var16, Block.leaves.blockID, 0);
									this.setBlockAndMetadata(par1World, var14, var11, var16, Block.leaves.blockID, 0);
								}
							}
						}
					}
					...
					for (var11 = 0; var11 < var6; ++var11)
					{
						...
						{
							//1
							this.setBlockAndMetadata(par1World, par3, par4 + (var6), par5, Block.wood.blockID, metaWood);
							this.setBlockAndMetadata(par1World, par3, par4 + (var6 + 1), par5, Block.wood.blockID, metaWood);
							this.setBlockAndMetadata(par1World, par3, par4 + (var6 + 2), par5, Block.wood.blockID, metaWood);
							this.setBlockAndMetadata(par1World, par3, par4 + (var6 + 3), par5, Block.wood.blockID, metaWood);
							this.setBlockAndMetadata(par1World, par3, par4 + (var6 + 4), par5, Block.wood.blockID, metaWood);
							this.setBlockAndMetadata(par1World, par3, par4 + (var6 + 5), par5, Block.wood.blockID, metaWood);
							this.setBlockAndMetadata(par1World, par3, par4 + var11, par5, Block.wood.blockID, metaWood);
							this.setBlockAndMetadata(par1World, par3 - 1, par4 + var11, par5, Block.wood.blockID, metaWood);
							this.setBlockAndMetadata(par1World, par3 + 1, par4 + var11, par5, Block.wood.blockID, metaWood);
							this.setBlockAndMetadata(par1World, par3, par4 + var11, par5 - 1, Block.wood.blockID, metaWood);
							this.setBlockAndMetadata(par1World, par3, par4 + var11, par5 + 1, Block.wood.blockID, metaWood);

							//2
							this.setBlockAndMetadata(par1World, par3 - 1, par4 + (var11 / 2), par5 - 1, Block.wood.blockID, metaWood);
							this.setBlockAndMetadata(par1World, par3 + 1, par4 + (var11 / 2), par5 - 1, Block.wood.blockID, metaWood);
							this.setBlockAndMetadata(par1World, par3 - 1, par4 + (var11 / 2), par5 + 1, Block.wood.blockID, metaWood);
							this.setBlockAndMetadata(par1World, par3 + 1, par4 + (var11 / 2), par5 + 1, Block.wood.blockID, metaWood);

							//3
							this.setBlockAndMetadata(par1World, par3 - 2, par4 + (var11 / 4), par5, Block.wood.blockID, metaWood);
							this.setBlockAndMetadata(par1World, par3 - 2, par4 + (var11 / 4), par5 - 1, Block.wood.blockID, metaWood);
							this.setBlockAndMetadata(par1World, par3 - 2, par4 + (var11 / 4), par5 + 1, Block.wood.blockID, metaWood);
							this.setBlockAndMetadata(par1World, par3 + 2, par4 + (var11 / 4), par5, Block.wood.blockID, metaWood);
							this.setBlockAndMetadata(par1World, par3 + 2, par4 + (var11 / 4), par5 - 1, Block.wood.blockID, metaWood);
							this.setBlockAndMetadata(par1World, par3 + 2, par4 + (var11 / 4), par5 + 1, Block.wood.blockID, metaWood);
							this.setBlockAndMetadata(par1World, par3, par4 + (var11 / 4), par5 - 2, Block.wood.blockID, metaWood);
							this.setBlockAndMetadata(par1World, par3 - 1, par4 + (var11 / 4), par5 - 2, Block.wood.blockID, metaWood);
							this.setBlockAndMetadata(par1World, par3 + 1, par4 + (var11 / 4), par5 - 2, Block.wood.blockID, metaWood);
							this.setBlockAndMetadata(par1World, par3, par4 + (var11 / 4), par5 + 2, Block.wood.blockID, metaWood);
							this.setBlockAndMetadata(par1World, par3 - 1, par4 + (var11 / 4), par5 + 2, Block.wood.blockID, metaWood);
							this.setBlockAndMetadata(par1World, par3 + 1, par4 + (var11 / 4), par5 + 2, Block.wood.blockID, metaWood);
							...
							//4
							this.setBlockAndMetadata(par1World, par3 - 2, par4 + (var11 / 6), par5 - 2, Block.wood.blockID, metaWood);
							this.setBlockAndMetadata(par1World, par3 + 2, par4 + (var11 / 6), par5 + 2, Block.wood.blockID, metaWood);
							this.setBlockAndMetadata(par1World, par3 + 2, par4 + (var11 / 6), par5 - 2, Block.wood.blockID, metaWood);
							this.setBlockAndMetadata(par1World, par3 - 2, par4 + (var11 / 6), par5 + 2, Block.wood.blockID, metaWood);
							this.setBlockAndMetadata(par1World, par3 - 3, par4 + (var11 / 6), par5, Block.wood.blockID, metaWood);
							this.setBlockAndMetadata(par1World, par3 + 3, par4 + (var11 / 6), par5, Block.wood.blockID, metaWood);
							this.setBlockAndMetadata(par1World, par3, par4 + (var11 / 6), par5 - 3, Block.wood.blockID, metaWood);
							this.setBlockAndMetadata(par1World, par3, par4 + (var11 / 6), par5 + 3, Block.wood.blockID, metaWood);

							//5
							this.setBlockAndMetadata(par1World, par3 - 3, par4 + (var11 / 8), par5 - 1, Block.wood.blockID, metaWood);
							this.setBlockAndMetadata(par1World, par3 - 3, par4 + (var11 / 8), par5 + 1, Block.wood.blockID, metaWood);
							this.setBlockAndMetadata(par1World, par3 + 3, par4 + (var11 / 8), par5 - 1, Block.wood.blockID, metaWood);
							this.setBlockAndMetadata(par1World, par3 + 3, par4 + (var11 / 8), par5 + 1, Block.wood.blockID, metaWood);
							this.setBlockAndMetadata(par1World, par3 - 1, par4 + (var11 / 8), par5 - 3, Block.wood.blockID, metaWood);
							this.setBlockAndMetadata(par1World, par3 + 1, par4 + (var11 / 8), par5 - 3, Block.wood.blockID, metaWood);
							this.setBlockAndMetadata(par1World, par3 - 1, par4 + (var11 / 8), par5 + 3, Block.wood.blockID, metaWood);
							this.setBlockAndMetadata(par1World, par3 + 1, par4 + (var11 / 8), par5 + 3, Block.wood.blockID, metaWood);
