...
public class WorldGenMinableBOP extends WorldGenMinable
{
    ...
    public WorldGenMinableBOP(int par1, int par2)
    {
        this(par1, par2, Block.stone.blockID);
    }

    public WorldGenMinableBOP(int par1, int par2, int par3)
    {
                        ...
                        if (var39 * var39 + var42 * var42 < 1.0D)
                        {
                            for (int var44 = var34; var44 <= var37; ++var44)
                            {
                                ...
                                if (var39 * var39 + var42 * var42 + var45 * var45 < 1.0D && par1World.getBlockId(var38, var41, var44) == this.field_94523_c)
                                {
                                    ...
                                    else if (var48.HasStrata() && (par1World.getBiomeGenForCoords(var38, var44) == BOPBiomes.volcano || par1World.getBiomeGenForCoords(var38 - 32, var44) == BOPBiomes.volcano || par1World.getBiomeGenForCoords(var38 + 32, var44) == BOPBiomes.volcano || par1World.getBiomeGenForCoords(var38, var44 - 32) == BOPBiomes.volcano || par1World.getBiomeGenForCoords(var38, var44 + 32) == BOPBiomes.volcano) && var41 >= 55 + par1World.rand.nextInt(2))
                                    {
                                        var47 = 1;
                                    }
