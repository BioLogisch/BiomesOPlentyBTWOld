...
public class WorldGenTaiga6 extends WorldGenerator
{
	public WorldGenTaiga6(boolean par1)
	{
		super(par1);
	}
	...
	{
		int var6 = par2Random.nextInt(4) + 9;
		...
		if (par4 >= 1 && par4 + var6 + 1 <= 256)
		{
			...
			else
			{
				...
				if ((var11 == Block.stone.blockID) && par4 < 256 - var6 - 1)
				{
