...
public class WorldGenBog2 extends WorldGenerator
{
	@Override
	public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
	{
		...
		for (var6 = par2Random.nextInt(4) + 7; par1World.getBlockMaterial(par3, par4 - 1, par5) == Material.water; --par4)
		{
			;
		}
				...
				if ((var8 == Block.grass.blockID || var8 == Block.dirt.blockID) && par4 < 128 - var6 - 1)
				{
					...
					for (var16 = 0; var16 < var6; ++var16)
					{
						...
						if (var10 == 0 || var10 == Block.leaves.blockID || var10 == Block.waterMoving.blockID || var10 == Block.waterStill.blockID)
						{
							...
							this.setBlockAndMetadata(par1World, par3 - 1, par4, par5, Block.wood.blockID, 4);
							this.setBlockAndMetadata(par1World, par3 + 1, par4, par5, Block.wood.blockID, 4);
							this.setBlockAndMetadata(par1World, par3, par4, par5 - 1, Block.wood.blockID, 8);
							this.setBlockAndMetadata(par1World, par3, par4, par5 + 1, Block.wood.blockID, 8);
							this.setBlockAndMetadata(par1World, par3 - 1, par4 + (var6 - 4), par5, Block.wood.blockID, 4);
							this.setBlockAndMetadata(par1World, par3 + 1, par4 + (var6 - 4), par5, Block.wood.blockID, 4);
							this.setBlockAndMetadata(par1World, par3, par4 + (var6 - 4), par5 - 1, Block.wood.blockID, 8);
							this.setBlockAndMetadata(par1World, par3, par4 + (var6 - 4), par5 + 1, Block.wood.blockID, 8);
							this.setBlock(par1World, par3 - 2, par4 + (var6 - 3), par5, Block.wood.blockID);
							this.setBlock(par1World, par3 + 2, par4 + (var6 - 3), par5, Block.wood.blockID);
							this.setBlock(par1World, par3, par4 + (var6 - 3), par5 - 2, Block.wood.blockID);
							this.setBlock(par1World, par3, par4 + (var6 - 3), par5 + 2, Block.wood.blockID);
						}
					}
