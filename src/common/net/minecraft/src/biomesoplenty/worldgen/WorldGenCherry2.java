...
public class WorldGenCherry2 extends WorldGenerator
{
	/**
	...
	public WorldGenCherry2(boolean par1)
	{
		super(par1);
	}
		...
		for (var11[par5] = var10[par5]; var12 <= var7; ++var12)
		{
			...
			while (var13 <= var7)
			{
				...
				else
				{
					...
					if (var14 != 0 && var14 != BOPAPIBlocks.leaves2.blockID)
					{
						++var13;
					}
					else
					{
						this.setBlockAndMetadata(worldObj, var11[0], var11[1], var11[2], par6, 3);
						++var13;
					}
				}
			}
	 ...
	 float layerSize(int par1)
	{
	 ...
	 void generateLeafNode(int par1, int par2, int par3)
	 {
		 ...
		 for (int var5 = par2 + leafDistanceLimit; var4 < var5; ++var4)
		 {
			 ...
			 this.genTreeLayer(par1, var4, par3, var6, (byte)1, BOPAPIBlocks.leaves2.blockID);
		 }
	 }
	 ...
	 void generateTrunk()
	 {
		 ...
		 this.placeBlockLine(var5, var6, BOPAPIBlocks.logs1.blockID);
	 ...
	 void generateLeafNodeBases()
	 {
		 ...
		 for (int[] var3 = new int[] {basePos[0], basePos[1], basePos[2]}; var1 < var2; ++var1)
		 {
			 ...
			 {
				 this.placeBlockLine(var3, var5, BOPAPIBlocks.logs1.blockID);
			 }
		 }
	 }
	 ...
	 int checkBlockLine(int[] par1ArrayOfInteger, int[] par2ArrayOfInteger)
	 {
		 ...
		 else
		 {
			 ...
			 for (var15 = var3[var5] + var8; var14 != var15; var14 += var8)
			 {
				 ...
				 if (var16 != 0 && var16 != BOPAPIBlocks.leaves2.blockID)
				 {
					 break;
				 }
			 }
