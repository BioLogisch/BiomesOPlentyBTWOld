...
{
	public WorldGenIceTree(boolean par1)
	{
		super(par1);
	}
	...
	public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
	{
		...
		int var8 = var6 - var7;
		int var9 = 4 + par2Random.nextInt(2);
		boolean var10 = true;
		...
		if (par4 >= 1 && par4 + var6 + 1 <= 256)
		{
				...
				for (var13 = par3 - var21; var13 <= par3 + var21 && var10; ++var13)
				{
					for (int var14 = par5 - var21; var14 <= par5 + var21 && var10; ++var14)
					{
						if (var11 >= 0 && var11 < 256)
						{
							...
							if (var15 != 0 && var15 != Block.ice.blockID)
							{
								var10 = false;
							}
						}
			...
			else
			{
				...
				if ((var11 == Block.blockSnow.blockID) && par4 < 256 - var6 - 1)
				{
					this.setBlock(par1World, par3, par4 - 1, par5, Block.blockSnow.blockID);
					...
					for (var15 = 0; var15 <= var8; ++var15)
					{
						...
						for (var17 = par3 - var21; var17 <= par3 + var21; ++var17)
						{
							...
							for (int var19 = par5 - var21; var19 <= par5 + var21; ++var19)
							{
								...
								{
									this.setBlockAndMetadata(par1World, var17, var16, var19, Block.ice.blockID, 1);
								}
							}
						}
					...
					for (var16 = 0; var16 < var6 - var15; ++var16)
					{
						...
						if (var17 == 0 || var17 == Block.ice.blockID)
						{
							this.setBlockAndMetadata(par1World, par3, par4 + var16, par5, Block.ice.blockID, 1);
						}
					}
