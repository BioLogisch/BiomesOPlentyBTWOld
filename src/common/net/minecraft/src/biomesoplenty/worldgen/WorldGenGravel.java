...
public class WorldGenGravel extends WorldGenerator
{
	...
	public WorldGenGravel(int par1, int par2)
	{
		sandID = par2;
		radius = par1;
	}
				...
				for (int var9 = par5 - var6; var9 <= par5 + var6; ++var9)
				{
					...
					if (var10 * var10 + var11 * var11 <= var6 * var6)
					{
						for (int var12 = par4 - var7; var12 <= par4 + var7; ++var12)
						{
							...
							if (var13 == Block.dirt.blockID || var13 == Block.grass.blockID || var13 == Block.stone.blockID)
							{
								par1World.setBlock(var8, var12, var9, Block.gravel.blockID);
							}
						}
					}
				}
