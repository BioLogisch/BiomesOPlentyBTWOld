...
public class WorldGenRainforestTree1 extends WorldGenerator
{
			...
			else
			{
				...
				if ((var8 == Block.grass.blockID || var8 == Block.dirt.blockID) && par4 < 256 - var6 - 1)
				{
						...
						for (var14 = par3 - var13; var14 <= par3 + var13; ++var14)
						{
							...
							for (int var16 = par5 - var13; var16 <= par5 + var13; ++var16)
							{
								...
								if ((Math.abs(var15) != var13 || Math.abs(var17) != var13 || par2Random.nextInt(2) != 0 && var12 != 0) &&
										(block == null || par1World.getBlockId(var14, var11, var16) == Block.leaves.blockID))
								{
					...
					for (var11 = 0; var11 < var6; ++var11)
					{
						...
						if (var12 == 0 || block == null || var12 == Block.leaves.blockID)
						{
						...
						for (var11 = par4 - 3 + var6; var11 <= par4 + var6; ++var11)
						{
							...
							for (var14 = par3 - var13; var14 <= par3 + var13; ++var14)
							{
								for (var15 = par5 - var13; var15 <= par5 + var13; ++var15)
								{
									...
									if (block != null && par1World.getBlockId(var14, var11, var15) == Block.leaves.blockID)
									{
