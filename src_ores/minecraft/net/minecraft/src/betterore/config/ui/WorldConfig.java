package net.minecraft.src.betterore.config.ui;
...
public class WorldConfig
{
	...
	{
		this(ConfigDir.getConfigDir(), (WorldInfo)null, (File)null, (World)null, (File)null);
	}

	public WorldConfig(WorldInfo worldInfo, File worldBaseDir) throws IOException, ParserConfigurationException, SAXException
	{
		this(ConfigDir.getConfigDir(), worldInfo, worldBaseDir, (World)null, (File)null);
	}
