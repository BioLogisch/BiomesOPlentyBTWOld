...
public class BOBlockDescriptor implements Copyable<BOBlockDescriptor>
{
    ...
    public BOBlockDescriptor()
    {
        this.clear();
    }

    public BOBlockDescriptor(String descriptor)
    {
        this.set(descriptor);
    }

    public void copyFrom(BOBlockDescriptor source)
    {
    ...
    public BOBlockDescriptor set(String descriptor)
    {
        this.clear();
    ...
    public BOBlockDescriptor add(String descriptor)
    {
        return this.add(descriptor, 1.0F);
    }

    public BOBlockDescriptor add(String descriptor, float weight)
    {
    ...
    public BOBlockDescriptor clear()
    {
        this._compiled = false;
