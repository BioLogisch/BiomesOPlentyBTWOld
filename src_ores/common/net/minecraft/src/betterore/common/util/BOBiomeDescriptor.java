...
import net.minecraft.src.betterore.common.generator.settings.BODistributionSettingMap.Copyable;


public class BOBiomeDescriptor implements Copyable<BOBiomeDescriptor>
{
    ...
    public BOBiomeDescriptor()
    {
        this.clear();
    }

    public BOBiomeDescriptor(String descriptor)
    {
        this.set(descriptor);
    }
    
    public void copyFrom(BOBiomeDescriptor source)
    {
    ...
    public BOBiomeDescriptor set(String descriptor)
    {
        this.clear();
    ...
    public BOBiomeDescriptor add(String descriptor)
    {
        return this.add(descriptor, 1.0F);
    }

    public BOBiomeDescriptor add(String descriptor, float weight)
    {
        return this.add(descriptor, 1.0F, new Climate(), false);
    }
    
    public BOBiomeDescriptor add(String descriptor, float weight, Climate climate, boolean describesType)
    {
    ...
    public BOBiomeDescriptor addAll(BOBiomeDescriptor descriptor, float weight) {
    	this._compiled = false;
    	if (weight == 1.0F) {
    ...
    public BOBiomeDescriptor clear()
    {
        this._compiled = false;
    ...
    protected float matchingWeight(BiomeGenBase biome)
    {
        ...
        BOBiomeDictionary.Type[] types = BOBiomeDictionary.getTypesForBiome(biome);
        ...
        for (Descriptor desc : this._descriptors) {
            ...
            if (desc.describesType) {
            	for (BOBiomeDictionary.Type type : types) {	
