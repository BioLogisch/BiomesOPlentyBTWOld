...
import static net.minecraft.src.betterore.common.util.BOBiomeDictionary.Type.BEACH;
import static net.minecraft.src.betterore.common.util.BOBiomeDictionary.Type.DESERT;
import static net.minecraft.src.betterore.common.util.BOBiomeDictionary.Type.END;
import static net.minecraft.src.betterore.common.util.BOBiomeDictionary.Type.FOREST;
import static net.minecraft.src.betterore.common.util.BOBiomeDictionary.Type.FROZEN;
import static net.minecraft.src.betterore.common.util.BOBiomeDictionary.Type.JUNGLE;
import static net.minecraft.src.betterore.common.util.BOBiomeDictionary.Type.MOUNTAIN;
import static net.minecraft.src.betterore.common.util.BOBiomeDictionary.Type.MUSHROOM;
import static net.minecraft.src.betterore.common.util.BOBiomeDictionary.Type.NETHER;
import static net.minecraft.src.betterore.common.util.BOBiomeDictionary.Type.PLAINS;
import static net.minecraft.src.betterore.common.util.BOBiomeDictionary.Type.SWAMP;
import static net.minecraft.src.betterore.common.util.BOBiomeDictionary.Type.WATER;
...
public class BOBiomeDictionary
{
    public enum Type
    {
        FOREST,
    ...
    {    
        if(biome.theBiomeDecorator.treesPerChunk >= 3)
        {
            ...
            {
                BOBiomeDictionary.registerBiomeType(biome, JUNGLE);
            }
            else if(!biome.isHighHumidity())
            {
                BOBiomeDictionary.registerBiomeType(biome, FOREST);
            }
        }
        else if(biome.maxHeight <= 0.3F && biome.maxHeight >= 0.0F)
        {
            ...
            {
                BOBiomeDictionary.registerBiomeType(biome, PLAINS);
            }
        }

        if(biome.isHighHumidity() && biome.minHeight < 0.0F && (biome.maxHeight <= 0.3F && biome.maxHeight >= 0.0F))
        {
            BOBiomeDictionary.registerBiomeType(biome, SWAMP);
        }

        if(biome.minHeight <= -0.5F)
        {
            BOBiomeDictionary.registerBiomeType(biome, WATER);
        }

        if(biome.maxHeight >= 1.5F)
        {
            BOBiomeDictionary.registerBiomeType(biome, MOUNTAIN);
        }
        
        if(biome.getEnableSnow() || biome.temperature < 0.2F)
        {
            BOBiomeDictionary.registerBiomeType(biome, FROZEN);
        }
        
        if(!biome.isHighHumidity() && biome.temperature >= 1.0F)
        {
            BOBiomeDictionary.registerBiomeType(biome, DESERT);
        }
    }
