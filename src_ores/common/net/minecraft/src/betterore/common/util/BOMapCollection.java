...
public abstract class BOMapCollection<K,V> implements Collection<V>
{
    protected final Map<K,V> backingMap;

    public BOMapCollection(Map<K,V> backingMap)
    {
    ...
    {
        return obj instanceof BOMapCollection ? this.backingMap.equals(((BOMapCollection)obj).backingMap) : false;
    }
