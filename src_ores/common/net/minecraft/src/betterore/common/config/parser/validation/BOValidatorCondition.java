...
public abstract class BOValidatorCondition extends BOValidatorNode
{
    protected boolean invert = false;

    protected BOValidatorCondition(BOValidatorNode parent, Node node, boolean invert)
    {
        super(parent, node);
        this.invert = invert;
    }
    ...
    protected boolean validateChildren() throws BOParserException
    {
        ...
        if (trueBlock == null)
        {
            if (falseBlock != null)
            {
                throw new BOParserException("Cannot have Else without Then", falseBlock);
            }
        ...
        if (resultBlock != null)
        {
            (new BOValidatorUnchecked(this, resultBlock)).validate();
        }
    ...
    protected abstract boolean evaluateCondition() throws BOParserException;
}
