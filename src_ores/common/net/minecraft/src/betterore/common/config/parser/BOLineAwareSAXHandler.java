...
public class BOLineAwareSAXHandler extends DefaultHandler
{
    private Locator locator = null;
    private final Stack nodeStack = new Stack();

    public BOLineAwareSAXHandler(Node root)
    {
    ...
    public void fatalError(SAXParseException ex) throws BOParserException
    {
        throw new BOParserException(ex.getMessage(), (Node)this.nodeStack.peek(), this.locator.getLineNumber(), ex);
    }
}
