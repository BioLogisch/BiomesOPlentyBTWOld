...
public class BOParserException extends SAXException
{
    public final Node node;
    public int lineNumber;

    public BOParserException(String message, Node node, int lineNumber, Exception parent)
    {
    ...
    public BOParserException(String message, Node node, int lineNumber)
    {
        super(message);
        this.node = node;
        this.lineNumber = lineNumber;
    ...
    public BOParserException(String message, Node node, Exception parent)
    {
        this(message, node, -1, parent);
    }

    public BOParserException(String message, Node node)
    {
        this(message, node, -1);
    }

    public BOParserException(String message, int lineNumber, Exception parent)
    {
        this(message, (Node)null, lineNumber, parent);
    }

    public BOParserException(String message, int lineNumber)
    {
        this(message, (Node)null, lineNumber);
    }

    public BOParserException(String message, Exception parent)
    {
        this(message, (Node)null, -1, parent);
    }

    public BOParserException(String message)
    {
        this(message, (Node)null, -1);
    }

    public BOParserException(Exception parent)
    {
        super(parent);
        this.node = null;
        this.lineNumber = -1;
