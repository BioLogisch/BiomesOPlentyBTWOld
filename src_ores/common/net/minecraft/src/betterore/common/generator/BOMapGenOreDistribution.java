...
public abstract class BOMapGenOreDistribution extends MapGenStructure implements IBOOreDistribution
{
    @DistributionSetting(
            name = "Name",
            inherited = false,
    ...
    protected final BODistributionSettingMap _settingMap;

    public BOMapGenOreDistribution(BODistributionSettingMap settingMap, int distributionID, boolean canGenerate)
    {
        this.replaceableBlocks = new BOBlockDescriptor(Integer.toString(Block.stone.blockID));
        this.biomes = new BOBiomeDescriptor(".*");
        this.frequency = new BOPDist(0.025F, 0.0F);
        this.parent = null;
        this.parentRangeLimit = new BOPDist(32.0F, 32.0F, Type.normal);
        this.wfHasBB = false;
    ...
    public void inheritFrom(IBOOreDistribution inherits) throws IllegalArgumentException
    {
    ...
    public class StructureGroup extends StructureStart
    {
        ...
        public StructureGroup(int chunkX, int chunkZ, int structureCount)
        {
            ...
            for (int i = 0; i < structureCount; ++i)
            {
                ...
                if (BOMapGenOreDistribution.this.generateStructure(this, random) != null)
                {
                    ++trueStructureCount;
                }
            }
            ...
            else
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            ++this.placedBlocks;
                            ++BOMapGenOreDistribution.this.placedBlocks;
