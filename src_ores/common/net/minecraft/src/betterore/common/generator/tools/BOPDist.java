...
public class BOPDist implements Copyable<BOPDist>
{
    public float mean;
    public float range;
    public Type type;
    ...
    public BOPDist(float mean, float range, Type type)
    {
        this.set(mean, range, type);
    }

    public BOPDist(float mean, float range)
    {
    ...
    public void copyFrom(BOPDist source)
    {
    ...
    public BOPDist set(float mean, float range, Type type)
    {
        this.mean = mean;
