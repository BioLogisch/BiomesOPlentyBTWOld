package net.minecraft.src.betterore.common.generator.tools;

public class BOTransform implements Cloneable
{
    private float[] mat;
    ...
    protected BOTransform(float[] matrix)
    {
        this.mat = matrix;
    }

    public BOTransform clone()
    {
        return new BOTransform((float[])this.mat.clone());
    }
    ...
    public BOTransform transform(BOTransform trans)
    {
    ...
    public BOTransform rotate(float angle, float axisX, float axisY, float axisZ)
    {
    ...
    public BOTransform rotateX(float angle)
    {
        float s = (float)Math.sin((double)angle);
    ...
    public BOTransform rotateY(float angle)
    {
        float s = (float)Math.sin((double)angle);
        float c = (float)Math.cos((double)angle);
        float tmp = 0.0F;
    ...
    public BOTransform rotateZ(float angle)
    {
        float s = (float)Math.sin((double)angle);
        float c = (float)Math.cos((double)angle);
        float tmp = 0.0F;
    ...
    public BOTransform rotateXInto(float axisX, float axisY, float axisZ)
    {
        float r = axisX * axisX + axisY * axisY + axisZ * axisZ;
    ...
    public BOTransform rotateYInto(float axisX, float axisY, float axisZ)
    {
        float r = axisX * axisX + axisY * axisY + axisZ * axisZ;
    ...
    public BOTransform rotateZInto(float axisX, float axisY, float axisZ)
    {
        float r = axisX * axisX + axisY * axisY + axisZ * axisZ;
    ...
    public BOTransform scale(float scaleM, float axisX, float axisY, float axisZ)
    {
        float r = axisX * axisX + axisY * axisY + axisZ * axisZ;
    ...
    public BOTransform scale(float scaleX, float scaleY, float scaleZ)
    {
        this.mat[0] *= scaleX;
        this.mat[1] *= scaleY;
        this.mat[2] *= scaleZ;
    ...
    public BOTransform shear(float angle, float shearX, float shearY, float shearZ, float invariantX, float invariantY, float invariantZ)
    {
    ...
    public BOTransform reflect(float mirrorNormalX, float mirrorNormalY, float mirrorNormalZ)
    {
    ...
    public BOTransform translate(float transX, float transY, float transZ)
    {
