package net.minecraft.src.betterore.common.generator.settings;
...
public class BODistributionSettingMap
{
    private final Map<String,Object[]> _settingMap = new BOCIStringMap(new LinkedHashMap());

    public BODistributionSettingMap(Class distributionType)
    {
    ...
    {
        BOCIStringMap<String> descriptions = new BOCIStringMap(new LinkedHashMap());
    ...
    public Object get(IBOOreDistribution dist, String settingName)
    {
        if (dist == null)
        {
            return null;
    ...
    public void set(IBOOreDistribution dist, String settingName, Object value) throws IllegalArgumentException, IllegalAccessException
    {
        if (dist != null)
        {
            ...
            else
            {
                ...
                {
                    value = BOConfigParser.parseString(field.getType(), (String)value);
                }
    ...
    public void inheritAll(IBOOreDistribution source, IBOOreDistribution destination)
    {
