...
import net.minecraft.src.betterore.common.generator.tools.BOTransform;
import net.minecraft.src.betterore.common.util.BOLogger;



public class BOMapGenVeins extends BOMapGenOreDistribution
{
    @DistributionSetting(
            name = "branchType",
    ...
    public BOMapGenVeins(int distributionID, boolean canGenerate)
    {
        ...
        this.mlSize = new BOPDist(2.5F, 1.0F);
        this.mlHeight = new BOPDist(32.0F, 16.0F, Type.normal);
        this.brFrequency = new BOPDist(3.0F, 2.0F);
        this.brInclination = new BOPDist(0.0F, 0.55F);
        this.brLength = new BOPDist(120.0F, 60.0F);
        this.brHeightLimit = new BOPDist(16.0F, 0.0F);
        this.sgForkFrequency = new BOPDist(0.2F, 0.0F);
        this.sgForkLenMult = new BOPDist(0.75F, 0.25F);
        this.sgLength = new BOPDist(15.0F, 6.0F);
        this.sgAngle = new BOPDist(0.5F, 0.5F);
        this.sgRadius = new BOPDist(0.5F, 0.3F);
        this.orDensity = new BOPDist(1.0F, 0.0F);
        this.orRadiusMult = new BOPDist(1.0F, 0.1F);
    ...
    public Component generateStructure(StructureGroup structureGroup, Random random)
    {
        ...
        {
            BOTransform mlMat = new BOTransform();
            ...
            for (int br = this.brFrequency.getIntValue(random); br > 0; --br)
            {
                ...
                BOTransform segMat = new BOTransform();
    ...
    public void generateBranch(StructureGroup structureGroup, float length, float maxHeight, float minHeight, BOTransform mat, Component parent, Random random)
    {
        ...
        while (length > 0.0F)
        {
            ...
            BOTransform segMat = mat.clone().scale(segRad, segRad, segLen);
    ...
    private class BezierTubeComponent extends Component
    {
        ...
        protected final BOTransform mat;

        public BezierTubeComponent(StructureGroup structureGroup, BOTransform transform)
        {
    ...
    {
        protected final BOTransform mat;
        protected final BOTransform invMat;

        public SolidSphereComponent(StructureGroup structureGroup, BOTransform transform)
        {
            super(structureGroup);
